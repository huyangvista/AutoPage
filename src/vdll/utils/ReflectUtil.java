...
public class ReflectUtil {
	 ...
	 * @return 返回值
	 */
	public static Object invokeSet(Object object, String propertiesName, Object... value) {
		return invokeSet(object, propertiesName, getArgs(value), value);
	}
	...
	@Target(value = {ElementType.CONSTRUCTOR, ElementType.FIELD, ElementType.LOCAL_VARIABLE, ElementType.METHOD, ElementType.PACKAGE, ElementType.PARAMETER, ElementType.TYPE}) //此处成为元注解 ，注解的定义需要元注解
