package vdll.debug;//package vdll.debug;//package vdll.tools;
//
//
////libs/android.jar
...
//
//		ReflectUtil.invokeStaticMethod(ReflectUtil.getClassFromName("com.flyoung.hello.Hello") , "main", new Class<?>[]{String.class, String.class}, new Object[] { new String[] {  "8","8" } });
//		Object hello = ReflectUtil.newInstance(ReflectUtil.getClassFromName("com.flyoung.hello.Hello"), new Class<?>[]{}, new Object[] {});
//        ReflectUtil.invokeMethod(hello, "main",new Class<?>[]{String.class, String.class}, new Object[] { new String[] { "80","80" } });
//
//	}
//
//	public VBuild()
...
//            String vsBuildPath = "./bin/"; // "./build/classes/" <=jsp | java=> "./bin/"; //编译目录需要与项目相同 否则制定加载器路径
//
//
//			JavaCompiler javaCompiler = ToolProvider.getSystemJavaCompiler();
